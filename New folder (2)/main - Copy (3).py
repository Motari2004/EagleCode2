...
if DATABASE_URL:
    ...
    try:
        ...
        # ========== ADD UPGRADE REQUESTS TABLE HERE ==========
        class UpgradeRequest(Base):
            ...
            requested_plan = Column(String, nullable=False)  # pro, business, custom
...
"""
        ...
        try:
            ...
            if preview_result.get("success"):
                ...
                # IMPORTANT: Send as file_complete so frontend finds it in files
                await websocket.send_json({
                    "type": "file_complete",
                    "file": "preview_html",
                ...
                print(f"✅ Preview sent ({len(preview_html):,} chars)")
